...
export default function AdminPage() {
  ...
  if (loading) return <div className={styles.loading}><i className="ti ti-loader" style={{fontSize:32,animation:'spin 1s linear infinite'}}/><style>{`@keyframes spin{from{transform:rotate(0)}to{transform:rotate(360deg)}}`}</style></div>
    ...
    <div className={styles.page}>
      <div className={styles.topbar}>
        <div>
          ...
          <div className={styles.sub}>Visão geral de todos os alunos e custos</div>
        </div>
      </div>
      ...
      <div className={styles.content}>
        <div className={styles.stats}>
          <div className={styles.stat}>
            ...
            <div className={styles.statUp}>↑ estimado</div>
          </div>
          <div className={styles.stat}>
            ...
            <div className={styles.statUp} style={{color:'var(--muted2)'}}>Kling + OpenAI</div>
          </div>
          <div className={styles.stat}>
          ...
          <div className={styles.stat}>
            ...
            <div className={styles.statUp}>{stats.videos} vídeos gerados</div>
          </div>
        </div>
